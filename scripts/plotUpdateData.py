...
def main(argv):
   ...
   try:
     ...
     print 'plotUpdateData.py -i <fileoffiles> -d <dbname>'
     sys.exit(2)
...
#     print row
   ...
   tmp_title = dbname.upper() + " Update Latency Histogram(Log Scale)"
...
#############################################################
   ...
   tmp_title = dbname.upper() + " Update Throughput"
   ...
   fname = "UpdateThroughput."+dbname+".png"
   plt.savefig(fname)
